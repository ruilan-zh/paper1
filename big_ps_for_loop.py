...
if nfile==2:
	...
	tng_data1 = np.loadtxt(f"/cosma8/data/dp004/dc-zhan5/shuffled/logM10_dlogM0.1_snap40/gal_ps/shuffle_sat/seed{seed}.txt")
...
print("Nmeshxy:", Nmesh)
pixlen_mpc_h = boxsize_tng / (Nmesh+1)
...
odir = f"ps_data/snap{snapnum}/mvir/shuffled/logM10_dlogM0.1/gal_ps/shuffle_sat"
