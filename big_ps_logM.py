...
if halo_type == "gal":
    ...
    tng_data1 = np.loadtxt(f"{tng_dir}/toy_models/weighted_c4_rvir0.5_n50/nfw_sat_pos_w2_w4_in_rs.txt")
    ...
    tng_data1 = np.loadtxt(f"{tng_dir}/weighted_c4_rvir0.5_n50/nfw_sat_sum_pos_w2_w4_in_rs.txt")
