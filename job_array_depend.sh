...
split_name="split_nan/msat_sum_split2/conc_proxy_split2"
object2shuffle="gal"

#mpirun -n $SLURM_NTASKS $RP_OPENMPI_ARGS python3 big_ps_for_loop.py $SLURM_NTASKS  $istart
mpirun -np $SLURM_NTASKS python3 big_ps_for_loop_depend.py $SLURM_NTASKS $istart $logM_name $split_name $object2shuffle
