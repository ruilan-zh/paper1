...
if nfile==2:
	...
	tng_data1 = np.loadtxt(f"/cosma8/data/dp004/dc-zhan5/shuffled/logM10_dlogM0.1_snap40/gal_ps/shuffle_{object2shuffle}/{logM_range}/{sfr_range}/{bh_range}/seed{seed}{shuffle_name}.txt")
...
odir = f"ps_data/snap{snapnum}/mvir/shuffled/logM10_dlogM0.1/gal_ps/shuffle_{object2shuffle}/{logM_range}/{sfr_range}/{bh_range}"
