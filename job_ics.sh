...
#SBATCH --ntasks 224 #number of cores
...
#mpirun -n $SLURM_NTASKS $RP_OPENMPI_ARGS python3 big_ps_ics.py $SLURM_NTASKS
mpirun -n $SLURM_NTASKS $RP_OPENMPI_ARGS python3 big_ps_dm.py $SLURM_NTASKS
#mpirun -np $SLURM_NTASKS python3 big_ps_dm.py $SLURM_NTASKS
