...
if nfile==2:
    ...
    logM_range1=""
    #conc_split1="msat_sum_split8"
    #conc_split1="test_split4"
    conc_split1 = conc_split
    ...
    mask1 = (mhalo_tng1 > 11) & (mhalo_tng1 < 13.8)
    ...
    #tng_data_base = np.loadtxt(f"/cosma7/data/dp004/dc-zhan5/shuffled/logM10_dlogM0.1_snap40/{changed_bins}/{ps_type}_ps/shuffle_{object2shuffle}/seed{seed}{shuffle_name}.txt")
    tng_data_base = np.loadtxt(f"/cosma7/data/dp004/dc-zhan5/shuffled/logM10_dlogM0.1_snap40/{changed_bins}/{ps_type}_ps/shuffle_{object2shuffle}/seed{seed}{shuffle_name}.txt")
    ...
    mhalo_tng = np.concatenate((mhalo_tng1[mask1], mhalo_tng_base[mask_base]))
    pos_tng = np.concatenate((pos_tng1[mask1],pos_tng_base[mask_base]))
    sfr_tng = np.concatenate((sfr_tng1[mask1], sfr_tng_base[mask_base]))
...
odir = f"ps_data/snap{snapnum}/mvir/shuffled/logM10_dlogM0.1/{changed_bins}/{ps_type}_ps/shuffle_{object2shuffle}/shuffle_all/logM11-13.8/{sfr_range}/{bh_range}/{conc_split1}"
