...
shuffler = shuffle.Shuffler(ps_type="gal", object2shuffle="gal",include_bh=True, include_halo_structure=True, include_msat_sum=True, include_conc_proxy=True)
...
def shuffle(seed):
	shuffler.shuffle_in_bins(seed=seed, Nsplit=Nsplit, split_property2="msat_sum", split_test=False, Nsplit2=Nsplit2, split_property="conc_proxy")
	#shuffler.shuffle_in_bins(seed=seed, Nsplit=Nsplit, split_property="msat_sum", split_test=False)
