...
radius = 0.1
gaussian_filter = nbodykit.filters.Gaussian(radius)
top_hat_filter = nbodykit.filters.TopHat(radius)
filter_type = top_hat_filter
mesh = mesh.apply(filter_type, mode="real", kind="index")
...
import pickle
odir=f"ps_data/snap{snapnum}/mvir/top_hat_filter"
...
fname = f"{odir}/r={radius}.pickle"
#fname = f"{odir}/r=tng.pickle"
