...
if nfile==2:
    ...
    tng_data2 = np.loadtxt(f"/cosma7/data/dp004/dc-zhan5/shuffled/logM10_dlogM0.1_snap40/{changed_bins}/{ps_type}_ps/shuffle_{object2shuffle}/{logM_range}/{sfr_range}/{bh_range}/{conc_split}/seed0{shuffle_name}.txt")
